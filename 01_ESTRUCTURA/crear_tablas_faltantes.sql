...
CREATE TABLE HISTORIAL_ACADEMICO (
    ...
    resultado VARCHAR2(15), -- APROBADO, REPROBADO, PERDIDA, CURSO, VALIDADO, HOMOLOGADO
    ...
    CONSTRAINT CHK_RESULTADO_HISTORIAL CHECK (resultado IN ('APROBADO', 'REPROBADO', 'PERDIDA', 'CURSO', 'VALIDADO', 'HOMOLOGADO', 'RETIRADO')),
